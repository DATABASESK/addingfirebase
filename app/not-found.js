        ...
        <div className="w-full max-w-[96rem] h-screen flex items-center justify-between">
          <div className="max-[700px]:w-full">
            ...
            <div className="text-[#ffffffc2] w-full max-[700px]:flex max-[700px]:justify-center">
              <div className="max-w-[28rem] max-[700px]:text-center">
                You've unlocked a hidden path, but it leads to nowhere. Let's get you back on track!
              </div>
            </div>

            {/* Button to go back to homepage */}
            <div className="w-full max-[700px]:flex max-[700px]:justify-center max-[700px]:mt-4">
              <button className="w-max h-max mt-5 hover:bg-slate-900 duration-100 text-white px-4 py-2 backdrop-blur-md text-[14px] border-[1px] border-[#ffffff4b] rounded-xl flex gap-2 items-center">
                Back To Homepage <span className="mt-[3px]"><FaArrowRight /></span>
              </button>
            </div>
          </div>

          {/* Embed skmovies.onrender.com website using iframe */}
          <div className="relative mt-4 w-full h-full">
            <iframe
              src="https://skmovies.onrender.com"
              width="100%"
              height="100%"
              title="SKMovies Website"
