export const getRecentTamilMovies = async (page = 1) => {
  ...
  // OTT Provider IDs (Netflix, Amazon Prime, Zee5, Aha, SunNXT, SonyLIV, JioCinema)
  const ottProviders = [8, 9, 119, 122, 224, 237, 339];
  ...
  console.log("Fetching URL:", url); // Debug: Check the request URL
  ...
  try {
    ...
    console.log("API Response:", data); // Debug: Check if TMDB returns results
